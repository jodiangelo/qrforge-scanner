...
const appCss = "/assets/styles-CyHT7bUk.css";
...
const Route$2 = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Generate QR codes from text or links and scan existing QR codes. Free, fast, dark-mode QR tool."
      },
      ...
      {
        property: "og:image",
        content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/e6a82191-0bb4-4d84-8463-209909971d2e"
      },
      {
        name: "twitter:image",
        content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/e6a82191-0bb4-4d84-8463-209909971d2e"
...
const BASE_URL = "https://qrforgescanner.lovable.app";
...
const $$splitComponentImporter = () => import("./index-Dykom81L.mjs");
